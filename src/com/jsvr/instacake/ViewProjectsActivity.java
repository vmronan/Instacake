...
//		Sync.updateMyProjects(userUid, accessToken, dm, updateProjectsListOnUiThread);
	...
	private void showProjects() {
		ArrayList<Project> projects = LocalClient.getProjectsList();
		ProjectsAdapter adapter = new ProjectsAdapter(this, R.layout.listview_project_row, projects);
...
//		Log.v("showProjects", numProjects + " projects found.");
//		Project[] projects = new Project[numProjects];
//		for(int i = 0; i < numProjects; i++) {
//			Log.v("showProjects", "Loading project " + (LocalClient.getProject(projectUids.get(i))).getTitle());
